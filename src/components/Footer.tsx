        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-[64px]">
          ...
          <div className="lg:col-span-4 flex flex-col items-start">
            ...
            <p className="text-[14px] text-[var(--color-text-secondary)] leading-[1.65] mb-8 max-w-sm">
              Mega Discount Bazar is your one-stop online shopping destination for unbeatable deals across fashion, skincare, and everyday essentials. We bring you a wide range of quality products at affordable prices, ensuring style, self-care, and savings all in one place.            </p>
