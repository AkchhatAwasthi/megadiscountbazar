            ...
            <aside className="lg:col-span-4 flex flex-col gap-4 sticky top-28">
              ...
              <div className="bg-white rounded-[16px] border border-[var(--color-border-default)] p-5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <Link href="/contact" className="text-[13px] font-[700] text-[var(--color-brand-red)] hover:underline mt-1.5 inline-block">
                    Contact Support
                  </Link>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {recommendations.map((product) => (
                <ProductCard
                  key={product.id}
                  product={product}
                  onViewDetail={() => router.push(`/product/${product.slug || product.id}`)}
                />
              ))}
            </div>
          </section>
