  ...
  if (cartItems.length === 0 && !showGuestOrderPopup) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--color-surface-page)] p-6 text-center">
         ...
         <Button onClick={() => router.push('/products')} className="bg-[var(--color-brand-red)] text-white rounded-[8px] px-10 h-12 font-[500] text-[14px] hover:bg-[var(--color-brand-red-deep)] transition-all">
           Start Shopping
         </Button>
      </div>
    );
