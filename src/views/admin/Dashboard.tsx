      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-[14px] border border-[var(--color-border-default)] overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border-default)]">
            ...
            <button onClick={() => router.push('/admin/orders')} className="flex items-center gap-1 text-[12px] font-[600] text-[var(--color-brand-red)] hover:underline">
        ...
        <div className="bg-white rounded-[14px] border border-[var(--color-border-default)] overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border-default)]">
            ...
            <button onClick={() => router.push('/admin/products')} className="flex items-center gap-1 text-[12px] font-[600] text-[var(--color-brand-red)] hover:underline">
              View all <ArrowRight size={12} />
            </button>
          </div>
          <div className="divide-y divide-[var(--color-border-default)]/60">
