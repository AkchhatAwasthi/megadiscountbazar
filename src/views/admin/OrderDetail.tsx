    ...
    try {
      ...
      if (data) {
        ...
        const orderDetail: OrderDetail = {
          ...
          cashfreePaymentId: data.razorpay_payment_id || undefined,
          cashfreeOrderId: data.razorpay_order_id || undefined,
          shippingAddress: {
          ...
          selectedSize: (data as any).selected_size || undefined,
        };
  ...
  if (!order) {
    return (
      <div className="container mx-auto px-4 py-8 text-center animate-in fade-in duration-500">
        ...
        <Button onClick={() => router.push('/admin/orders')} className="bg-[var(--color-brand-red)] hover:bg-[var(--color-brand-red-deep)] text-white uppercase tracking-wider text-[12px] font-[600] rounded-[6px] px-6">
          Back to Orders
        </Button>
      </div>
    );
    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-[1280px] mx-auto bg-[var(--color-surface-page)] min-h-screen pb-12">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          <Button variant="ghost" onClick={() => router.push('/admin/orders')} className="text-[var(--color-text-secondary)] hover:bg-[var(--color-brand-red-light)] hover:text-[var(--color-text-primary)] rounded-[8px]">
